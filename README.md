...
Deploy [deploy.yml](https://github.com/Dimokus88/Autonomy/blob/main/deploy.yml) **Autonomy** nodes with **Cloudmos (Akashlytics)** ([use instructions here](https://github.com/Dimokus88/guides/blob/main/Akashlytics/EN_guide.md)) by setting the values in the corresponding `deploy.yml` variables:
